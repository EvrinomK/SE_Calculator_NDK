...
Java_com_example_se_1calculator_GtestRunner_nInitialize(JNIEnv *env, jclass, jobject suite) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_se_1calculator_GtestRunner_nRun(JNIEnv *env, jclass, jobject notifier) {
    auto& listeners = ::testing::UnitTest::GetInstance()->listeners();
